...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        botaoEntrar = findViewById(R.id.login_botao);
            ...
            public void onClick(View v) {
                ...
                if (!textoEmail.isEmpty()) {
                    if (!textoSenha.isEmpty()) {
                        ...
                        Toast.makeText(LoginActivity.this, "Necessário preencher senha", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(LoginActivity.this, "Necessário preencher email", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    public void abrirTelaPrincipal() {
        startActivity(new Intent(this, NavegationDrawerActivity.class));
        finish();
    }
}
